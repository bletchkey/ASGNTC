...
from src.common.utils.scores import prediction_accuracy_bins, calculate_stable_target_complexity
...
class TestConfigPredictionAccuracy(unittest.TestCase):
    ...
    def test_accuracy_perfect_match(self):
        ...
        accuracy = prediction_accuracy_bins(prediction, target)
    ...
    def test_input_shape_mismatch(self):
        ...
        with self.assertRaises(ValueError):
            prediction_accuracy_bins(prediction, target)
