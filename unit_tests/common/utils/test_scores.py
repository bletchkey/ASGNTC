...
from src.common.utils.scores import config_prediction_accuracy_bins, calculate_stable_metric_complexity
...
class TestConfigPredictionAccuracy(unittest.TestCase):
    ...
    def test_accuracy_perfect_match(self):
        ...
        accuracy = config_prediction_accuracy_bins(prediction, target)
    ...
    def test_input_shape_mismatch(self):
        ...
        with self.assertRaises(ValueError):
            config_prediction_accuracy_bins(prediction, target)
