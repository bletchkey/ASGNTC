...
from .utils.helper_functions import set_grid_ncells, save_progress_plot, get_epoch_elapsed_time_minutes
...
def fit(model_g, model_p, optimizer_g, optimizer_p, criterion_g, criterion_p, fixed_noise, folders, device) -> list:
    ...
    for epoch in range(constants.num_epochs):
        ...
        epoch_elapsed_time_m = get_epoch_elapsed_time_minutes(steps_times)
